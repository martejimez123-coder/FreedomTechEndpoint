...
<a className={isHome ? "active" : ""} href={pageHref("home")} onClick={(e) => { goToPage(e, "home"); setMenuOpen(false); }}>Home</a>
<a className={isServices ? "active" : ""} href={pageHref("services")} onClick={(e) => { goToPage(e, "services"); setMenuOpen(false); }}>Services</a>
<a className={isAbout ? "active" : ""} href={pageHref("about")} onClick={(e) => { goToPage(e, "about"); setMenuOpen(false); }}>About</a>
<a className={isIndustries ? "active" : ""} href={pageHref("industries")} onClick={(e) => { goToPage(e, "industries"); setMenuOpen(false); }}>Who We Help</a>
<a className={isContact ? "active" : ""} href={pageHref("contact")} onClick={(e) => { goToPage(e, "contact"); setMenuOpen(false); }}>Contact</a>
</nav>
)}
</header>
