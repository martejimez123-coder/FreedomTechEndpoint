      ...
      <main>
          ...
          <div className="container hero-grid">
            <div className="hero-copy reveal reveal-text">
              ...
              <p className="hero-subtitle">
                FreedomTech LLC helps small businesses, offices, churches, nonprofits, and professional teams stay productive with fast troubleshooting, endpoint support, setup, maintenance, and practical technology solutions.
              </p>
        ...
        {isHome && <section className="intro section-pad">
          <div className="container intro-grid reveal reveal-text">
            ...
            <p>
              FreedomTech LLC provides business IT support in Philadelphia with a customer-first approach: clear communication, hands-on service, and technology help that makes sense for real offices and organizations.
            </p>
          </div>
        </section>}
        ...
        {isAbout && <section className="section-pad page-section" id="about">
          <div className="container split">
            ...
            <div className="about-copy reveal reveal-text">
              ...
              <p>
                We help clients solve device issues, support users, set up systems, troubleshoot connectivity, improve Microsoft 365 workflows, and keep business technology organized. The work is technical, but the experience should feel clear, professional, and easy to trust.
              </p>
